...
import { Home, Star, DollarSign, ShoppingBag, X, CheckCircle, ArrowLeft, Eye } from 'lucide-react';

const VipEvMalikane = () => {
  const [selectedUrun, setSelectedUrun] = useState(null);

  const urunler = [
    { id: 1, isim: "Şehir Merkezi Daire", fiyat: "500.000$", eskiFiyat: "600.000$", aciklama: "Downtown'da modern daire", resim: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800", indirim: "17%", yildiz: 4, ozellikler: ["2+1 Daire", "Şehir Manzarası", "Garaj", "Güvenlik"] },
    { id: 2, isim: "Vinewood Villa", fiyat: "2.000.000$", eskiFiyat: "2.500.000$", aciklama: "Vinewood Hills'te lüks villa", resim: "https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800", indirim: "20%", yildiz: 5, ozellikler: ["4+1 Villa", "Havuz", "Bahçe", "3 Araçlık Garaj"] },
    { id: 3, isim: "Sahil Evi", fiyat: "1.200.000$", eskiFiyat: "1.400.000$", aciklama: "Deniz kenarında huzurlu ev", resim: "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=800", indirim: "14%", yildiz: 4, ozellikler: ["3+1 Ev", "Özel Plaj", "İskele", "Tekne Yeri"] },
    { id: 4, isim: "Penthouse Suite", fiyat: "3.500.000$", eskiFiyat: "4.000.000$", aciklama: "En üst katta lüks penthouse", resim: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800", indirim: "12%", yildiz: 5, ozellikler: ["Penthouse", "360° Manzara", "Özel Asansör", "Teras"] },
    { id: 5, isim: "Malikane", fiyat: "8.000.000$", eskiFiyat: "10.000.000$", aciklama: "Devasa lüks malikane", resim: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800", indirim: "20%", yildiz: 5, ozellikler: ["10+ Oda", "Havuz", "Tenis Kortu", "Helikopter Pisti"] },
    { id: 6, isim: "Ada Evi", fiyat: "15.000.000$", eskiFiyat: "18.000.000$", aciklama: "Özel adada lüks yaşam", resim: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800", indirim: "17%", yildiz: 5, ozellikler: ["Özel Ada", "Malikane", "Yacht Limanı", "Helikopter"] }
  ];

  const colorClasses = { bg: 'from-emerald-500/20 to-teal-500/20', border: 'border-emerald-500/40', text: 'text-emerald-400', button: 'from-emerald-500 to-teal-500' };
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative pt-24 pb-12 px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          <Link to="/vip-store" className={`inline-flex items-center gap-2 px-4 py-2 mb-8 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 rounded-xl ${colorClasses.text} font-medium transition-all duration-300`}><ArrowLeft className="w-4 h-4" /><span>VIP Mağaza'ya Dön</span></Link>
          <div className="text-center mb-12">
            <div className={`inline-flex items-center justify-center w-20 h-20 mb-6 bg-gradient-to-br ${colorClasses.button} rounded-2xl shadow-2xl shadow-emerald-500/40`}><Home className="w-10 h-10 text-white" /></div>
            <h1 className="text-4xl md:text-6xl font-black mb-4"><span className="bg-gradient-to-r from-emerald-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">EV & MALİKANE</span></h1>
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto">Villalar, daireler ve malikâneler</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {urunler.map((urun) => (
              <div key={urun.id} onClick={() => setSelectedUrun(urun)} className={`group bg-gradient-to-br ${colorClasses.bg} border ${colorClasses.border} rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 cursor-pointer hover:scale-[1.02]`}>
